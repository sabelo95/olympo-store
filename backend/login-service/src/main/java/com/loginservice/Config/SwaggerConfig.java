    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("API RESTful para autenticación y gestión de usuarios. " +
                                "Proporciona endpoints para login, registro de usuarios, " +
                                "refresh de tokens JWT y gestión de sesiones.")
                        .contact(new Contact()
                                .name("Equipo Arka")
